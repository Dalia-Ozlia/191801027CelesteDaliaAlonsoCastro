 ...
 * @author celes
 */
public class IngresoCorrecto extends javax.swing.JFrame {

    /**
     * Creates new form ErrorPassword
     */
    public IngresoCorrecto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Elemento guardado correctamente.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngresoCorrecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IngresoCorrecto().setVisible(true);
            }
        });
    }
